...
curve(sin(x),0,100)
curve(sin, n=100) #預設只會0~1
#xname會帶入文字到輸入函數中
curve(sin, n=100, xlim=c(0,4*pi), xname="sin(x), 0~4*pi",xlab="")


curve(2*x^4+x^3+2, -10, 10)
curve(2*x^4+x^3+2, n=100, xlim=c(-10,10), xlab="2*x^4+x^3+2", ylab="")
